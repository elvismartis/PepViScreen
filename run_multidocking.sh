#!/bin/bash
echo "You are running run_multidocking.sh"
echo "Report bugs and issue to elvis.afmartis@gmail.com"



## Defining the piper PATH and PATH for parameters
PIPER_HOME=<PATH_TO_PIPER_PACKAGE>
...
do
	...
	cd $b
	cp $LIG ./
	$PIPER_HOME/prepare_for_piper.py ${b}.pdb
